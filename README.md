...
## Get Started
```
git clone https://github.com/Evenwang521/SPAR.git
cd src
```
## Scenes Preparation
### PROX
...
```
### Self-defined Scenes
If you want to run SPAR in self-defined scenes, we provide a simple reconstruction pipeline and data processing procedure to compute the SDF with semantic labels. 
