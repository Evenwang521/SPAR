...
def parse_config():
    ...
    parser.add_argument('--output_dir', type=str, default='$POSA_dir\\training')
    ...
    parser.add_argument('--model_folder', type=str, default='D:\data\\POSA_dir\smplx_models',
                        help='')
    ...
    parser.add_argument('--target_object',default = None,type = int)
    parser.add_argument('--scene_registration_file',default = "D:\code\python\POSA\\registration.pkl",type = str)
