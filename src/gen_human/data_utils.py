...
def pkl_to_canonical(pkl_file_path, device, dtype, batch_size, gender='male', model_folder=None, vertices_clothed=None,
    ...
    # pdb.set_trace()
    # scene_mesh = o3d.io.read_triangle_mesh("D:/data/POSA_dir/scenes/BasementSittingBooth.ply")
    # point_cloud = o3d.geometry.PointCloud()
    # point_cloud.points = o3d.utility.Vector3dVector((vertices - pelvis).detach().cpu().numpy())
    # point_cloud.paint_uniform_color([0.5, 0.5, 0.5])
    # o3d.visualization.draw_geometries([scene_mesh,point_cloud])
    # pdb.set_trace()
